...
export function Footer() {
    return (
    <footer className="w-screen fixed bottom-0 bg-zinc-800 border-t border-zinc-700 py-3 px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
            <Image src="/album2.jpg" width={56} height={56} alt="Album Cover"/>
            <div className="flex flex-col">
                <strong className="font-normal">Stone in Love</strong>
                <span className="text-xs text-zinc-400">Journey</span>
            </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-zinc-400">4:25</span>
            </div>
        </div>
